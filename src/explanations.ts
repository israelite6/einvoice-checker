...
export const EXPLANATIONS: Record<string, Text> = {
  ...
  'PDF-XML-NOMATCH': { de: 'Keiner der verglichenen XML-Werte wurde im PDF-Bild gefunden. Das Bild könnte andere Daten zeigen oder sie anders darstellen – bitte prüfen. Maßgeblich ist die XML.', en: 'None of the compared XML values were found in the PDF picture. The picture may show different data or print it differently – please check. The XML is authoritative.' },

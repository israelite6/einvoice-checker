...
mkdir -p ref ref-mut
java -jar vendor/validator-1.6.3-standalone.jar -s $V/scenarios.xml -r $V -o ref $(cat testfiles.txt) > ref/run.log
java -jar vendor/validator-1.6.3-standalone.jar -s $V/scenarios.xml -r $V -o ref-mut mutants/*.xml > ref-mut/run.log
